...
import help4img1 from '../en/4_import_export/1_export.png';
import help4img2 from '../en/4_import_export/2_import.png';
        ...
        <Typography variant="body1" component="div" paragraph>
          <Grid container spacing={1}>
            <Grid item sm={12} md={6} className={`${s.gridImg} ${s.gridImgSm}`}>
              <img src={help4img1} alt="eine Datei herunterladen" />
            </Grid>
            <Grid item sm={12} md={6} className={`${s.gridImg} ${s.gridImgSm}`}>
              <img src={help4img2} alt="eine Datei hochladen" />
            </Grid>
          </Grid>
        </Typography>
      </>
