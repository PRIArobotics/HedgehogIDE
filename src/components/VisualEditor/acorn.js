...
(function(root, mod) {
  ...
  const _prefix = { prefix: true, beforeExpr: true };
  ...
  for (const kw in keywordTypes) exports.tokTypes[`_${kw}`] = keywordTypes[kw];
  ...
  const isReservedWord5 = makePredicate(
  ...
  function skipBlockComment() {
    ...
    const start = tokPos;
    const end = input.indexOf('*/', (tokPos += 2));
